...
describe("Cline", () => {
    ...
    describe("constructor", () => {
        it("should respect provided settings", () => {
            const cline = new Cline(mockProvider, mockApiConfig, "custom instructions", false, 0.95, // 95% threshold
            "test task");
        ...
        it("should use provided fuzzy match threshold", () => {
            ...
            const cline = new Cline(mockProvider, mockApiConfig, "custom instructions", true, 0.9, // 90% threshold
            "test task");
            expect(cline.diffEnabled).toBe(true);
            expect(cline.diffStrategy).toBeDefined();
    ...
    describe("getEnvironmentDetails", () => {
        ...
        describe("API conversation handling", () => {
            ...
            it("should handle image blocks based on model capabilities", async () => {
                ...
                const clineWithImages = new Cline(mockProvider, configWithImages, undefined, false, undefined, "test task");
                ...
                const clineWithoutImages = new Cline(mockProvider, configWithoutImages, undefined, false, undefined, "test task");
            ...
            it("should handle API retry with countdown", async () => {
                ...
                expect(saySpy).toHaveBeenCalledWith("api_req_retry_delayed", expect.stringContaining("Retrying in 3 seconds"), undefined, true);
                expect(saySpy).toHaveBeenCalledWith("api_req_retry_delayed", expect.stringContaining("Retrying in 2 seconds"), undefined, true);
                expect(saySpy).toHaveBeenCalledWith("api_req_retry_delayed", expect.stringContaining("Retrying in 1 seconds"), undefined, true);
