...
describe("SYSTEM_PROMPT", () => {
    ...
    it("should use promptComponent roleDefinition when available", async () => {
        ...
        const prompt = await SYSTEM_PROMPT(mockContext, "/test/path", false, undefined, undefined, undefined, defaultModeSlug, customModePrompts, undefined, undefined, undefined, undefined, experiments);
    ...
    describe("experimental tools", () => {
        ...
        it("should provide detailed instructions for each enabled tool", async () => {
            ...
            const prompt = await SYSTEM_PROMPT(mockContext, "/test/path", false, undefined, new SearchReplaceDiffStrategy(), undefined, defaultModeSlug, undefined, undefined, undefined, undefined, true, experiments);
...
describe("addCustomInstructions", () => {
    ...
    it("should generate correct prompt for architect mode", async () => {
        ...
        undefined, // customModePrompts
        undefined, // customModes
        undefined, undefined, undefined, experiments);
        expect(prompt).toMatchSnapshot();
    });
