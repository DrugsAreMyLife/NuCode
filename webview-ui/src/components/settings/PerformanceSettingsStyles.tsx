...
export const PerformanceGroup = styled.div`
  display: flex;
  flex-direction: column;
  gap: 10px;
  padding: 12px;
...
export const PerformanceTitle = styled.span`
  font-weight: 500;
  font-size: 14px;
`;

export const PerformanceSettings = styled.div`
  display: flex;
  flex-direction: column;
  gap: 10px;
`;
...
export const ResourceLimitGroup = styled.div`
  display: flex;
  flex-direction: column;
  gap: 5px;
  margin-top: 10px;
...
export const ResourceLimit = styled.div`
  display: flex;
  align-items: center;
  gap: 10px;
`;
