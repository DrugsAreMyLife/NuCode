...
import {
  ...
  Gradient,
  ExpandLink,
  MODEL_PICKER_Z_INDEX
} from "./ModelPickerStyles"

interface GlamaModelPickerProps {}

const GlamaModelPicker: React.FC<GlamaModelPickerProps> = () => {
    ...
    <>
      ...
      {hasInfo ? (
        ...
        <Description>
          ...
          <StyledLink href="https://glama.ai/models">Glama.</StyledLink>
          {" "}If you're unsure which model to choose, Roo Code works best with{" "}
          <StyledLink onClick={() => handleModelChange("anthropic/claude-3.5-sonnet")}>
